      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <a href="https://www.linkedin.com/in/rahul-mahanthi-048a2623a/" className="text-xl hover:text-blue-400 transition duration-300">
              <FontAwesomeIcon icon={faLinkedin} />
            </a>
            <a href="https://github.com/RahulMahanthi" className="text-xl hover:text-gray-400 transition duration-300">
        ...
        <div className="mt-2 pt-2 border-t border-gray-700 flex flex-wrap items-center justify-between">
          <p className="text-xs text-gray-400">
            © {currentYear} Mahanthi Rahul. All rights reserved.
          </p>
          <p className="text-xs text-gray-400">
